/*******************************************************************************
 * Copyright (c) 2017, 2018 Red Hat Inc., Intel Corporation and others.
...
/**
 * Forked from ContainercommandLauncherFactory
 *
			...
			if (enablementProperty != null) {
				...
				if (enableContainer) {
					...
					if (paths.size() > 0) {
						...
						int status = launcher.fetchContainerDirs(connectionName, imageName, paths, hostDir);
					}
				}
			}
		}
